...
namespace InputBlock
{
    ...
    public static class MouseSimulator
    {
        ...
        {
            mouse_event(((int)button), 0, 0, 0, GlobalHook.CUSTSKEYSTROKE);
        }
        ...
        {
            mouse_event(((int)button) * 2, 0, 0, 0, GlobalHook.CUSTSKEYSTROKE);
        }
        ...
        public static void MouseWheel(int delta)
        {
            ...
            mouse_event(MOUSEEVENTF_WHEEL, 0, 0, delta, GlobalHook.CUSTSKEYSTROKE);
